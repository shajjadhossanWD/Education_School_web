...
const Slider = () => {
    return (
        ...
        <Carousel.Item>
          <img
            className="d-block  carouselImg"
            src="https://www.iso.org/files/live/sites/isoorg/files/about%20ISO/what_we_do/research_and_education/img/research.jpg/thumbnails/1200x600"
            alt="Second slide"
          />
        ...
        <Carousel.Item>
          <img
            className="d-block  carouselImg"
            src="https://airodoctor.com/wp-content/uploads/2021/09/office-aerosols-pollution-cognitive.jpg"
            alt="Third slide"
          />
          ...
          <h1 className="heading">Welcome To WEBEDU.</h1>
            ...
            <p  className="w-50 mx-auto mb-5 pb-5 text-dark fw-bold">Here you can learn all those things which is very important for our modern live, if you want to became a programmer it's perfect for you.</p>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
    );
